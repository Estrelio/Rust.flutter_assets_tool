pub mod migrate_flutter_gen_style {
    ...
    pub async fn migrate_flutter_gen_style(
        ...
        let join_handles: Arc<
            Mutex<Vec<tokio::task::JoinHandle<Result<(), MigrateFlutterGenStyleError>>>>,
    ...
    fn migrate_asset_core(
        ...
        regex
            .replace_all(&file_content, |_captures: &regex::Captures| -> String {
                let asset_usage_syntax = asset_metadata
                    .compute_dart_usage_syntax(to_style)
                    .unwrap();
                format!(
        ...
        "#;
            ...
            let asset_usage_regex_set_group =
                crate::core::asset_usage::compute_asset_usage_regex_set_group(
                    ...
                    .unwrap();
            let regex = &asset_usage_regex_set_group.regexes.iter().find(|x| x.1 == asset_metadata).unwrap().0;
