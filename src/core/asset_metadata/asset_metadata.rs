...
impl AssetMetadata {
    ...
    pub fn compute_dart_usage_syntax(&self, flutter_gen_assets_outputs_style: FlutterGenAssetsOutputsStyle) -> Result<String, AssetMetadataError> {
        ...
        let relative_asset_path: PathBuf = self.located_directory.components()
...
mod tests {
    ...
    fn compute_dart_usage_syntax_passes_when_requesting_camel_case() {
        ...
        // Act
        let usage_syntax = asset_metadata.compute_dart_usage_syntax(FlutterGenAssetsOutputsStyle::CamelCase).unwrap();
    ...
    fn compute_dart_usage_syntax_passes_when_requesting_dot_delimited() {
        ...
        // Act
        let usage_syntax = asset_metadata.compute_dart_usage_syntax(FlutterGenAssetsOutputsStyle::DotDelimited).unwrap();
